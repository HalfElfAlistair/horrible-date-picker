export const BackSpace = ({ height, width, fill }) => {
    return (
        <svg className='backspaceIcon' xmlns="http://www.w3.org/2000/svg" height={height} viewBox="0 -960 960 960" width={width} fill={fill}>
